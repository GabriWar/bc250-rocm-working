...
- **Mesa/RADV** (3 patches): turns the compute queue on and fixes the dispatch corruption,
  plus correct GFX10.1 detection. Optionally: native mesh/task shaders and mesh-shader queries.
...
| 0002 | native mesh + task shaders, Vulkan 1.4 | comment out to skip |
| 0003 | mesh/task pipeline-statistics queries | comment out to skip (needs 0002) |
